        ...
        foreach ($posts as $post) { ?>
         ...
         <div class="card" style="width: 18rem;">
             ...
             <div class="card-body">
                  ...
                  <h6 class="card-subtitle mb-2 text-muted"><?= $post['ville'] . ' - '.'Salle' .' ' . $post['salle'] .'-'. '<br>'. 'Du'.' ' . $post['dateD'] .'<br>'.'Au'.' '.$post['dateF'].' '  ?></h6>
                  <p class="card-text"><?= substr($post['descri'],0,100). '...' ?></p>
                 <a href="index.php?page=cirque=<?= $post ['id'] ?>" class="btn btn-secondary">Lire la suite</a>
             </div>
         </div>
        ...
        foreach ($posts as $post) { ?>
         ...
         <div class="card" style="width: 18rem;">
             ...
             <div class="card-body">
                  ...
                  <h6 class="card-subtitle mb-2 text-muted"><?= $post['ville'] . ' - '.'Salle' .' ' . $post['salle'] .'-'. '<br>'. 'Du'.' ' . $post['dateD'] .'<br>'.'Au'.' '.$post['dateF'].' '  ?></h6>
                  <p class="card-text"><?= substr($post['descri'],0,100). '...' ?></p>
                 <a href="index.php?page=concert<?= $post ['id'] ?>" class="btn btn-secondary">Lire la suite</a>
             </div>
         </div>
